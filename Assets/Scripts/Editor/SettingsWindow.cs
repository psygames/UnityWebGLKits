...
namespace WebGLKits.Editor
{
    internal class SettingsWindow : EditorWindow
    {
        ...
        internal static void Open()
        {
            ...
            window = GetWindow<SettingsWindow>(true, "WebGL Kits");
        ...
        private void DrawLogo()
        {
            ...
            var title = "<color=#3A9AD8><b>WebGL Kits</b></color>";
